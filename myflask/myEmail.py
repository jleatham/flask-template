...
def create_email_html(archList):
    ...
    htmlMsg = Environment().from_string(htmlTemplate).render(
        ...
        tableStyle = 'style="margin:5px;width:50%;border=2px;cellpadding=0;cellspacing=0;border-radius:1px;font-family:-webkit-standard;letter-spacing:normal;orphans:auto;text-indent:0px;text-transform:none;widows:auto;word-spacing:0px;-webkit-text-size-adjust:auto;-webkit-text-stroke-width:0px;text-decoration:none;border-collapse:collapse;"',
