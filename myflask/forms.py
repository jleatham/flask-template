...
class archWeekForm(FlaskForm):
    ...
    category	  = SelectField('Category', choices=[('news','News'),('demo','Demonstrations'),('service','Services / AS'),('spiff','SPIFFs'),('capital','Capital'),('ea','EA'),('proposal','Unsolicitad BoMs / Proposals'),('promo','Product Promotions')], validators=[DataRequired()])
